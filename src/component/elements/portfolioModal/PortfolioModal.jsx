...
import {
  AiOutlineClockCircle, AiTwotoneAppstore, AiOutlineShareAlt, AiOutlineTags
} from 'react-icons/ai'
import {PopupWrapper, ProjectDetails, ScrollableImg, VideoPlayer} from '../index'
...
const PortfolioModal = ({onClose, popupData}) => {
  ...
  return (
    <>
    <div 
      className="relative h-full w-full flex justify-center items-center bg-black flex-col rounded-md p-3"
    >
        {/* Close Modal */}
        <button
        ...
        >
          <div className="">
            ...
            <p className="text-[#696969] text-[15px] font-secondary mt-5">
              {description}
            </p>
          </div>
