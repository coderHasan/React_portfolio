...
const PortfolioCard = ({title, images, type, onClick}) => {
  return (
    <div
    ...
    >
        <span
            className="absolute top-0 left-0 text-white text-3xl w-full h-full flex justify-center items-center opacity-0 card-icon-visibility transition duration-300"
        >
            <BsEye/>
        </span>
        <img 
        ...
        />
        <div       
            className="Portfolio__card_overlay_text"
        >
